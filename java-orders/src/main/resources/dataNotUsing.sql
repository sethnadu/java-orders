...
VALUES  (1, 'Ramasundar', 'Bangalore', 0.15, '077-25814763', 'USA'),
        (2, 'Alex ', 'London', 0.13, '075-12458969', 'USA'),
        (3, 'Alford', 'New York', 0.12, '044-25874365', 'USA'),
        (4, 'Ravi Kumar', 'Bangalore', 0.15, '077-45625874', 'USA'),
        (5, 'Santakumar', 'Chennai', 0.14, '007-22388644', 'USA'),
        (6, 'Lucida', 'San Jose', 0.12, '044-52981425', 'USA'),
        (7, 'Anderson', 'Brisban', 0.13, '045-21447739', 'USA'),
        (8, 'Subbarao', 'Bangalore', 0.14, '077-12346674', 'USA'),
        (9, 'Mukesh', 'Mumbai', 0.11, '029-12358964', 'USA'),
        (10, 'McDen', 'London', 0.15, '078-22255588', 'USA'),
        (11, 'Ivan', 'Torento', 0.15, '008-22544166', 'USA'),
        (12, 'Benjamin', 'Hampshair', 0.11, '008-22536178', 'USA');
​
...
VALUES  (1, 'Holmes', 'London', 'London', 'UK', '2', 6000.00, 5000.00, 7000.00, 4000.00, 'BBBBBBB', 3),
        ...
        (4, 'Ravindran', 'Bangalore', 'Bangalore', 'India', '2', 5000.00, 7000.00, 4000.00, 8000.00, 'VAVAVA', 11),
        ...
        (19, 'Steven', 'San Jose', 'San Jose', 'USA', '1', 5000.00, 7000.00, 9000.00, 3000.00, 'KRFYGJK', 2),
...
​
INSERT INTO orders (ordnum, ordamount, advanceamount, custcode, orddescription)
VALUES  (1, 1000.00, 600.00, 13, 'SOD'),
        (2, 3000.00, 500.00, 19, 'SOD'),
        (3, 4500.00, 900.00, 7, 'SOD'),
        (4, 2000.00, 400.00, 16, 'SOD'),
        (5, 4000.00, 600.00, 22, 'SOD'),
        (6, 2000.00, 300.00, 12, 'SOD'),
        (7, 3500.00, 2000.00, 2, 'SOD'),
        (8, 2500.00, 400.00, 3, 'SOD'),
        (9, 500.00, 100.00, 23, 'SOD'),
        (10, 4000.00, 700.00, 7, 'SOD'),
        (11, 1500.00, 600.00, 8, 'SOD'),
        (12, 2500.00, 400.00, 25, 'SOD');
​
